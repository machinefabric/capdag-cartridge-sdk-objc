 ...
 */
@interface LBVRStandardCaps : NSObject
 ...
 * @param idString The cap ID string (e.g., "action=extract;target=metadata;type=document", "action=extract;target=pages;type=document")
 * @return The cap or nil if not found
 */
